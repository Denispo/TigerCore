...
class BaseRestRouter implements ICanMatchRoutes {
    ...
    * @return void
    */
   public function addRoute(string|array $method, VO_RouteMask $mask, mixed $handler = null, mixed $customData = null):void {
   ...
   public function runMatch(VO_HttpRequestMethod $requestMethod, string $requestUrlPath):ICanGetPayloadRawData|null
   {
      ...
      switch ($routeInfo[0]) {
         ...
         default:
         {
            ...
            /**
             * @var $handler ICanHandleMatchedRoute|null|(Closure(): ICanHandleMatchedRoute)
             */
            ...
            if (!$handler instanceof ICanHandleMatchedRoute) {
               throw new S500_InternalServerErrorException('Handler has to implement ICanHandleMatchedRoute or Closure(): ICanHandleMatchedRoute',['utl' => $requestUrlPath]);
            }
